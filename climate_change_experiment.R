...
source("/Users/robert.urban/Desktop/two/Functions for toy range dynamic model.R")
source("/Users/robert.urban/Desktop/two/Toy range dynamic model.R")
#source("Rscripts/create theoretical landscape.R")
Path=("/Users/robert.urban/Desktop/two") # folder wher results canbe stored

speciesPool <- read.csv(file="/Users/robert.urban/Desktop/two/speciesPool.csv")###################################################################

modelVector <- c('Beverton')
TempCangeYear<-c(0.00, 0.02, 0.04, 0.06)
scenarioVectorNames<-c('Scenario1: 0,00', 'Scenario2: 0,02', 'Scenario3: 0,04', 'Scenario2: 0,06')
  ...
  for (speciesPoolIndex in 1:nrow(speciesPool)) {
    for (scenarioIndex in 1:length(TempCangeYear)){
      ...
      for(landscapeIndex in 1:length(landscapeVector)){
        ...
        result <- EcoSimulation(InputParameter = "/Users/robert.urban/Desktop/two/Test_1.csv",#######################################################
                                StoragePath = Path,
                                Experiment = T,
...
#save
write.csv(ClimateChangeExperiment,"/Users/robert.urban/Desktop/two/ClimateChangeExperiment.csv")#############################################################
write.csv(ClimateChangeExtinction,"/Users/robert.urban/Desktop/two/ClimateChangeExtinction.csv")
